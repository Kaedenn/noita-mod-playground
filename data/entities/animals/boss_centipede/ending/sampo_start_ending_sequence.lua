...
if orb_count < 33 then
	if orb_count > ORB_COUNT_IN_WORLD and newgame_orbs_required >= ORB_COUNT_IN_WORLD and orb_count >= newgame_orbs_required then
		enter_ngplus = true
	elseif orb_count >= newgame_orbs_required and orb_count < ORB_COUNT_IN_WORLD then
		enter_ngplus = true
	end
end
